<?php
// Privacy Policy Page for Esports Management Website
...
<head>
    ...
    <title>Privacy Policy | Esports Management</title>
...
<body>
    ...
    <main class="container privacy-policy">
        ...
        <section>
            ...
            <p>Welcome to the Esports Management platform. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</p>
        ...
        <section>
            ...
            <p>We may collect personal information that you voluntarily provide to us when registering for our services, expressing an interest in obtaining information about us or our products and services, or otherwise contacting us. The personal information we collect may include:</p>
            <ul>
                <li>Name</li>
                <li>Email address</li>
                <li>Phone number</li>
                <li>Address</li>
                <li>Gaming platform usernames and IDs</li>
                <li>Date of birth</li>
            ...
            <p>Our servers automatically collect information when you access the Site, such as your IP address, browser type, operating system, access times, and the pages you have viewed directly before and after accessing the Site. If you are using our mobile application, this information may also include your device name and type, operating system, phone number, country, and other interactions with the application.</p>
            
            <h3>2.3 Gaming Data</h3>
            <p>With your consent, we may collect data about your gaming activities, statistics, performance metrics, team participation, and tournament results for the purpose of providing our esports management services.</p>
        </section>
        ...
        <section>
            ...
            <ul>
                ...
                <li>Facilitate team formation and tournament participation</li>
        ...
        <section>
            ...
            <p>If you interact with other users of our site, those users may see your name, profile photo, and descriptions of your gaming activity.</p>
            
            <h3>4.5 Tournament and Event Organizers</h3>
            <p>We may share your information with tournament and event organizers when you participate in competitions through our platform.</p>
        </section>
